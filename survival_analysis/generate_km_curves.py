...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate Kaplan-Meier survival curves from cell abundance data")
    parser.add_argument("--data-dir", required=True, help="Directory containing cell_abundance.csv and project_labels.csv")
    parser.add_argument("--output-dir", required=True, help="Directory to save KM curves and summary")
